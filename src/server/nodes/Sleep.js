...
var Sleep = /** @class */ (function (_super) {
    ...
    function Sleep(options) {
        ...
        return _super.call(this, __assign({ 
            // Defaults
            name: 'Sleep', summary: 'Sleep x seconds', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: ['Output'] }, options)) || this;
    }
    ...
    Sleep.prototype.getParameters = function () {
        return __spreadArrays(_super.prototype.getParameters.call(this), [
            NodeParameter_1["default"].number('seconds_to_sleep').withValue(5),
        ]);
    };
    return Sleep;
