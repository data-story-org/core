...
var CreateSequence = /** @class */ (function (_super) {
    __extends(CreateSequence, _super);
    function CreateSequence(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, __assign({ 
            // Defaults
            name: 'CreateSequence', summary: 'Create a sequence of objects', category: 'Reader', defaultInPorts: [], defaultOutPorts: ['Output'] }, options)) || this;
    }
    ...
    CreateSequence.prototype.getParameters = function () {
