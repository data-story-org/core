...
var CreateAttribute = /** @class */ (function (_super) {
    __extends(CreateAttribute, _super);
    function CreateAttribute(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, __assign({ 
            // Defaults
            name: 'CreateAttribute', summary: 'Create a new attribute from an expression', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: ['Output'] }, options)) || this;
    }
    CreateAttribute.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.output(this.input().map(function (feature) { return feature.set(attribute, value); }));
                return [2 /*return*/];
            });
        });
    };
    CreateAttribute.prototype.getParameters = function () {
