...
var RegExpFilter = /** @class */ (function (_super) {
    ...
    function RegExpFilter(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, __assign({ 
            // Defaults
            name: 'RegExpFilter', summary: 'Filter features matching an attribute regular expression', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: ['Passed', 'Failed'] }, options)) || this;
    }
    RegExpFilter.prototype.getParameters = function () {
    ...
    RegExpFilter.prototype.filterByRegExp = function (features, returnFailed) {
        var _this = this;
        if (returnFailed === void 0) { returnFailed = false; }
    ...
    RegExpFilter.prototype.getExpression = function () {
        var cleaned = Str_1.trim(this.getParameterValue('expression'), '/');
