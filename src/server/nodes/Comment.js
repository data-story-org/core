...
var Comment = /** @class */ (function (_super) {
    ...
    function Comment(options) {
        ...
        return _super.call(this, __assign({ 
            // Defaults
            name: 'Comment', summary: 'Add a comment', category: 'Workflow', defaultInPorts: [], defaultOutPorts: [] }, options)) || this;
    }
    ...
    Comment.prototype.getParameters = function () {
        return __spreadArrays(_super.prototype.getParameters.call(this), [
            NodeParameter_1["default"].string('text').withValue('This is a comment'),
        ]);
    };
    return Comment;
