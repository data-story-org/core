...
var FilterDuplicates = /** @class */ (function (_super) {
    __extends(FilterDuplicates, _super);
    function FilterDuplicates(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, __assign({ 
            // Defaults
            name: 'FilterDuplicates', summary: 'Remove duplicates', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: ['Output'] }, options)) || this;
    }
    FilterDuplicates.prototype.run = function () {
    ...
    FilterDuplicates.prototype.getParameters = function () {
    ...
    FilterDuplicates.prototype.uniqueFeatures = function (all) {
