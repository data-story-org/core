...
var ThrowError = /** @class */ (function (_super) {
    ...
    function ThrowError(options) {
        ...
        return _super.call(this, __assign({ 
            // Defaults
            name: 'ThrowError', summary: 'Throws an error', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: [] }, options)) || this;
    }
    ThrowError.prototype.run = function () {
    ...
    ThrowError.prototype.getParameters = function () {
