...
var Sort = /** @class */ (function (_super) {
    ...
    function Sort(options) {
        ...
        return _super.call(this, __assign({ 
            // Defaults
            name: 'Sort', summary: 'Sort features', category: 'Workflow', defaultInPorts: ['Input'], defaultOutPorts: ['Output'] }, options)) || this;
    }
    ...
    Sort.prototype.sortGlobal = function () {
        var sortAttribute = this.getParameterValue('sort_attribute');
        this.output(this.input().sort(function (f1, f2) {
    ...
    Sort.prototype.sortLocal = function () {
        var sortAttribute = this.getParameterValue('sort_attribute');
